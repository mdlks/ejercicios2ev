...
public class PrincipalPokemon
{
	...
	public static void main(String[] args)
	{
		...
		TreeMap<String ,Set<Pokemon>> jugadores=new TreeMap();    	//creo mapa de nombre jugador y pokemons
		TreeMap<String, Integer >insignias=new TreeMap();			//creo mapa de nombre jugador e insignias que gana
		...
		while (jugar==true)
		{
			...
			if (entradaR.length==4) 					
			{
				try 			//Integer.parseInt puede producir una excepcion 
				{
					...
					{
						Set<Pokemon> conj=new HashSet();		//creo conjunto de objetos Pokemon y añado el Pokemon
						conj.add(pok);							
